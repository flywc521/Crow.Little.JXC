...
WHERE [ID] = @ID ";
			...
			paramList.Add(DBAccesser.DbInstance.BuildDbParameter("@SizeValue", model.SizeValue, DbType.String));
			paramList.Add(DBAccesser.DbInstance.BuildDbParameter("@StandardSizeValue", model.StandardSizeValue, DbType.String));
